...
@Composable
    ...
    Scaffold(bottomBar = { Sikt_BottomBar(onNavigateToMap, onNavigateToFav, onNavigateToSettings, onNavigateToRules, favoritt = Sikt_lyseblå, settings = Sikt_lyseblå, rules = Sikt_lyseblå, map = Sikt_mellomblå) }) {
        Box(
